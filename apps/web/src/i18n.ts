...
const ENUMS: Record<string, Pair> = {
  ...
  // icon variants
  patriarch: ["族长", "Patriarch"], matriarch: ["女族长", "Matriarch"], king: ["君主", "King"], queen: ["王后", "Queen"],
  prophet: ["先知", "Prophet"], priest: ["祭司", "Priest"], judge: ["士师", "Judge"], disciple: ["门徒", "Disciple"],
  missionary: ["宣教者", "Missionary"], ruler: ["统治者", "Ruler"], soldier: ["军事人物", "Military figure"],
  teacher: ["教师", "Teacher"], lawgiver: ["律法者", "Lawgiver"], person: ["人物", "Person"],
  // event type
  ...
  political: ["政治", "Political"], social: ["社会", "Social"], religious: ["宗教", "Religious"], migration: ["迁徙", "Migration"], other: ["其他", "Other"],
  // time
  ...
  school: ["学校", "School"], religious_site: ["宗教场所", "Religious site"], fictional_place: ["虚构地点", "Fictional place"], route_node: ["路线节点", "Route node"],
...
export const UI = {
  title: ["世界文学名著时空地图", "World Literature Atlas"],
  tagline: ["按时代、人物群与个人逐层展开", "Explore era by era, group by group, person by person"],
  loading: ["载入中", "Loading"],
  error: ["加载失败", "Load failed"],
  retry: ["重试", "Retry"],
  characters: ["人物", "People"], events: ["事件", "Events"], locations: ["地点", "Places"],
  routes: ["路线", "Routes"], relations: ["关系", "Relations"],
  sources: ["来源与数据说明", "Sources and data notes"],
  copy: ["复制深链接", "Copy deep link"], copied: ["已复制", "Copied"],
  ...
  searchEverything: ["搜索人物、事件、地点…", "Search people, events, places…"],
  ...
  trajectory: ["人物轨迹", "Person trajectory"],
  showTrajectory: ["显示所选人物轨迹", "Show the selected person’s trajectory"],
  ...
  literarySignificance: ["文学意义", "Literary significance"],
  historicalBackground: ["历史背景", "Historical background"],
  modernStatus: ["现代状态", "Present-day status"],
  ...
  dataNote: ["模糊年代与推定地点会明确标记；摘要为原创结构化描述。", "Uncertain dates and inferred places are explicitly marked; summaries are original structured descriptions."],
